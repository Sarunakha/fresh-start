...
export function BookServicePage() {
  ...
  const [serviceSuburb, setServiceSuburb] = React.useState("");
  const [serviceCategory, setServiceCategory] = React.useState("");
  const [preferredArrivalDate, setPreferredArrivalDate] = React.useState("");
        ...
        <Container className="grid gap-10 lg:grid-cols-2 lg:items-start">
          <div className="space-y-6">
            <p className="max-w-md text-sm leading-6 text-clinical-charcoal/70">
              Our Sydney-based team ensures medical-grade precision in every
              corner. Reach out for bespoke industrial or residential
              scheduling.
            </p>
            ...
            <div className="rounded-xl2 border border-black/5 bg-clinical-lavender p-6 shadow-clinicalSm">
              ...
              <div className="mt-1 text-sm text-clinical-charcoal/60">
                Hover a zone to confirm teams are active.
              </div>
              <div className="mt-5">
                <ServiceMap />
              </div>
          ...
          <div className="rounded-xl2 border border-black/5 bg-white p-8 shadow-clinical">
            ...
            <p className="mt-2 text-sm text-clinical-charcoal/65">
              Initialize your clinical-grade cleaning session in under 60
              seconds.
            </p>
